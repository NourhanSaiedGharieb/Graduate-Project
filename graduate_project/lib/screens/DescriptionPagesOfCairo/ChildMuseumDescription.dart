...
class _ChildDescriptionState extends State<ChildDescription> {
  ...
  return Scaffold(
      ...
      body:Container(
              ...
              children: [           
                ...
                Padding(
                  ...
                  child: Stack(children: [
                    Image.asset(
                      'images/The Child Description.png',height: 430,width: 15550,fit: BoxFit.cover,filterQuality: FilterQuality.high,                     
                    ),                 
                  ]),
                ),
                const Padding(
          ...
          SizedBox(height:17),
        Text(" The Child Museum: Located in Cairo, the \n Child Museum is dedicated to providing \n interactive educational experiences for \n children. Opened in 1986, the museum \n features exhibits and activities designed to \n stimulate creativity, curiosity, and learning \n in young visitors, covering topics such as \n science, history, culture, and the \n environment.",
            ...
            Center(
              ...
              Padding(
                    ...
                    child: ElevatedButton.icon(
                      ...
                      onPressed: () {
                        launchUrlString('https://maps.app.goo.gl/MnovHNZQHMS9p4s78');
                      },
                      label: const Text(
                        'Location.',
                        style:
