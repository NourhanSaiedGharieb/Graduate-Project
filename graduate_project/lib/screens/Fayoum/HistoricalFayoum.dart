...
class HistoricalFayoum extends StatefulWidget {
  const HistoricalFayoum({super.key});

  @override
  State<HistoricalFayoum> createState() => _HistoricalFayoumState();
}

class _HistoricalFayoumState extends State<HistoricalFayoum> {
  @override
